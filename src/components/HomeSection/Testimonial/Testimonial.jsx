    ...
    <div>
      ...
      <div className="glide-08 relative w-full">
        ...
        <div data-glide-el="track">
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-[50%] overflow-hidden p-0 pb-12">
            <li>
